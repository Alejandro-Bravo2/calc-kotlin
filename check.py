...
# Configuración
REPO_PATH = "../calc-kotlin"  # Ruta del repositorio local

COMMIT_INITIAL_MESSAGE = "Commit inicial"
COMMIT_DIVISION_ERROR_MESSAGE = "Funcionalidad división con error"
COMMIT_DIVISION_MESSAGE = "Funcionalidad división sin error"
COMMIT_SUMA_MESSAGE = "Funcionalidad suma"
COMMIT_RESTA_MESSAGE = "Funcionalidad resta"
...
for comment in COMMENTS:
    print(comment)
print(f"📊 Puntuación final: {TOTAL_SCORE}/100")
